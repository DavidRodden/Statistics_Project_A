...
* Time allocated to set up meetings in accordance with everyone's schedules
    * Entire group
* Discussed potential topics
    * Entire group
* Collected data pertaining to our topic through research
    * Khang Tran, Michael McIntosh
* Programmed & analyzed data
    * Entire group
* Knit our PDF often to make sure project was in pristine condition
    * Entire group
* Protected data through means of Git
    * David Rodden
* Follow up with instructor with questions
    * Michael McIntosh